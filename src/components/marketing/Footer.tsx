...
export default function Footer() {
  ...
  return (
    <footer className='bg-[#07351c] text-white lg:pl-24'>
      <div className='mx-auto max-w-7xl px-6 py-14 md:py-16'>
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10'>
          ...
          <div className='lg:col-span-2'>
            ...
            <p className='mt-4 max-w-sm text-sm leading-relaxed text-white/70'>
              The trusted global platform for academic recommendation letters.
              Secure, consent-driven, and built for privacy.
            </p>
        ...
        <div className='mt-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between'>
          <div className='text-xs text-white/50'>
            © 2025 ReadMyStudent. Owned and operated by YS2PC Research Group
