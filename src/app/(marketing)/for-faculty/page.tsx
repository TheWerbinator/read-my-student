...
export const metadata = {
  title: "For Faculty",
  description:
    "Streamline recommendation letters with AI-assisted drafting, streamlined workflows, and student deadline tracking—built to reduce faculty burden while maintaining academic integrity.",
};
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-10 items-start'>
            ...
            <div className='relative order-1 lg:order-2'>
              ...
              <p className='mt-5 max-w-2xl text-sm md:text-base leading-relaxed text-white/70'>
                Most faculty want to advocate for students — but the current
                system multiplies effort, scatters documents, and turns
                deadlines into inbox chaos. ReadMyStudent keeps integrity intact
              ...
              <div className='mt-8 grid grid-cols-1 sm:grid-cols-3 gap-3'>
                <StatPill
                  label='1 strong letter'
                  value='30–90 min'
                  icon={<Clock3 className='h-4 w-4' />}
                />
                <StatPill
                  label='Busy seasons'
                  value='dozens of requests'
                  icon={<Inbox className='h-4 w-4' />}
                />
                <StatPill
                  label='Portals + deadlines'
                  value='always different'
        ...
        <div className='mx-auto max-w-7xl px-6 py-16 md:py-24'>
          <div className='text-center'>
            ...
            <p className='mt-4 mx-auto max-w-3xl text-sm md:text-base leading-relaxed text-white/70'>
              Students don’t just want a letter — they want advocacy,
              continuity, trust, and leverage. A system that preserves strong
              letters and reduces friction amplifies opportunity.
            </p>
          </div>
          ...
          <div className='mt-14 grid grid-cols-1 lg:grid-cols-2 gap-6 items-start'>
            <div className='rounded-3xl bg-white/10 border border-white/15 px-8 py-8 transition-colors duration-300 hover:border-amber-300/60 hover:bg-white/15 hover:shadow-[0_18px_45px_rgba(245,197,66,0.18)]'>
              ...
              <p className='mt-3 text-sm md:text-base text-white/70 leading-relaxed'>
                ReadMyStudent is built to respect faculty workload while
                preserving confidentiality and integrity — so strong letters can
                remain strong, without burning you out.
              </p>
              ...
              <div className='mt-7 flex flex-col sm:flex-row gap-3'>
                ...
                <Link
                  href='/contact'
                  className='text-sm font-semibold text-white/75 hover:text-white transition-colors self-center'
                >
...
function Card({
  ...
  return (
    <div className={`${base} ${styles}`}>
      ...
      {footer ? (
        <div
          className={`mt-7 rounded-2xl border border-black/5 bg-[#fbfbf8] px-5 py-4 text-sm ${tone === "light" ? "text-[#0b5315]" : "text-white/75"}`}
        >
          {footer}
        </div>
      ) : null}
...
function DarkPairCard({
  ...
  return (
    <div className='rounded-3xl bg-white/10 border border-white/15 px-8 py-7 transition-colors duration-300 hover:border-amber-300/60 hover:bg-white/15 hover:shadow-[0_18px_45px_rgba(245,197,66,0.18)]'>
      <div className='flex items-start gap-3'>
        <div
          className={`h-12 w-12 rounded-2xl grid place-items-center border ${iconStyle}`}
        >
          {icon}
        </div>
        <div>
