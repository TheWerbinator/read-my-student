          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="mt-5 max-w-xl text-sm md:text-base leading-relaxed text-white/70">
                Traditional recommendation letters rely on manual trust, scattered portals,
                and emotional friction. We built ReadMyStudent to preserve integrity,
                protect privacy, and make the experience human.
              </p>
        ...
        <div className="mx-auto max-w-7xl px-6 py-16 md:py-24">
          <div className="text-center">
            ...
            <p className="mt-4 mx-auto max-w-3xl text-sm md:text-base leading-relaxed text-white/70">
              ReadMyStudent modernizes the workflow while preserving academic integrity
              and confidentiality.
            </p>
          </div>
