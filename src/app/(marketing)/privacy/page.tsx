...
export const metadata = {
  title: "Privacy Policy | ReadMyStudent",
  description:
        ...
        <div className="max-w-3xl space-y-10">
          ...
          <PolicySection title="6. Data sharing">
            ...
            <ul className="list-disc pl-5 mt-3 space-y-2">
              ...
              <li>With trusted infrastructure providers necessary to operate the service</li>
            </ul>
          </PolicySection>

          <PolicySection title="7. Data retention">
            We retain personal data only as long as necessary to operate the
            platform, meet legal obligations, and preserve auditability. Retention
            periods may vary based on account role and usage.
          </PolicySection>
