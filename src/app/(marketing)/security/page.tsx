      ...
      <section className="mx-auto max-w-7xl px-6 pt-16 md:pt-24 pb-10">
        <div className="max-w-3xl">
          ...
          <p className="mt-5 text-sm md:text-base leading-relaxed text-[#5f7f6f]">
            Recommendation letters are sensitive academic documents. ReadMyStudent
            is designed to reduce risk, prevent misuse, and keep access clear,
      ...
      <section className="mx-auto max-w-7xl px-6 pb-16 md:pb-24">
        <div className="max-w-3xl space-y-10">
          ...
          <SecuritySection title="Minimized data exposure">
            Access is limited to what is necessary for each role. Viewers receive
            read-only access. Links expire automatically. We avoid long-lived,
            broadly shareable URLs.
          </SecuritySection>
