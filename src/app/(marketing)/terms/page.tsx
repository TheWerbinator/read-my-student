...
export const metadata = {
  title: "Terms of Service | ReadMyStudent",
  description:
      ...
      <section className="mx-auto max-w-7xl px-6 pb-16 md:pb-24">
        <div className="max-w-3xl space-y-10">
          <TermsSection title="1. Overview">
            ReadMyStudent is a platform that helps students request,
            faculty submit, and authorized viewers securely access
            recommendation letters using consent-based, single-use links.
          </TermsSection>
