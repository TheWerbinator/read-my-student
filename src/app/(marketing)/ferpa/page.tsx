        ...
        <div className='max-w-3xl'>
          ...
          <div className='mt-8 flex flex-col sm:flex-row gap-3'>
            ...
            <LinkButton
              ...
              variant='secondary'
              size='lg'
              className='rounded-xl justify-center bg-[#eaf3ee] border border-green-900/10 hover:bg-[#dff0e6]'
            >
...
function ValueRow({
  ...
  return (
    <li className='flex items-start gap-3'>
      <div className='mt-0.5 h-11 w-11 shrink-0 rounded-2xl bg-green-900/10 text-green-900 grid place-items-center border border-green-900/10'>
        {icon}
      </div>
      <div>
