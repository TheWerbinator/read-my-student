          ...
          <div className="lg:col-span-7">
            ...
            <div className="mt-4 space-y-4 text-sm md:text-base leading-relaxed text-[#5f7f6f]">
              <p>
                ...
                high-stakes moment, and faculty are trying to help while juggling
                dozens of competing demands.
              </p>
              <p>
        ...
        <div className="rounded-3xl border border-[#0b4726]/10 bg-white px-7 py-8 shadow-[0_10px_30px_rgba(15,23,42,0.04)]">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center gap-3">
            <LinkButton
              ...
              variant="secondary"
              size="md"
              className="rounded-xl bg-[#eaf3ee] border border-[#0b4726]/10 hover:bg-[#dff0e6]"
            >
              See how it works
            </LinkButton>
...
function ValueRow({
  ...
  return (
    <li className="flex items-start gap-3">
      <div className="mt-0.5 h-11 w-11 rounded-2xl bg-[#0b4726]/10 text-[#0b4726] grid place-items-center border border-[#0b4726]/10">
        {icon}
      </div>
      <div>
        <div className="text-sm font-semibold text-[#0a2e1c]">{title}</div>
        <div className="mt-1 text-sm text-[#5f7f6f] leading-relaxed">{body}</div>
      </div>
    </li>
  );
}
